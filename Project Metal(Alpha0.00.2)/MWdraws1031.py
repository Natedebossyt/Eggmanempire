...
class Paint(object):
    ...
    def __init__(self):
        ...
        self.file_saver = Button(self.root, text='file', command=self.use_file)
        self.file_saver.grid(row=0, column=0)
    ...
    def use_file(self):
        self.activate_button(self.file_saver); import file__saver1031
