...
class Window(Frame):
    ...
    def clickversionButton(self):
        messagebox.showinfo("imagine os", "Imagine OS Build 1031")
...
bg = PhotoImage(file ="C:\\Users\\bella\\OneDrive\\Desktop\\IMA10 microware devs\\OS drive\\Microware\\testfiles\\backgroundimgs\\background1.png" ) 
